...
Some text on this page was taken directly from an older version of Mariam Aly's lab manual. Here is a link to the [current version](https://github.com/alylab/labmanual/blob/master/aly-lab-manual.pdf).

# Unity

Yes we seek unity! Unity is our UMass High Performance Computing Cluster. Here is are some tips for getting started.
